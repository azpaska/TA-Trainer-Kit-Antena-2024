...
class RadioFlowGraph(gr.top_block):
    def __init__(self, radio_id, frequency, freq_offset=0, 
        ...
        self.tx_rf_gain = 14 # dB, 0 or 14 (no steps available)
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(100, firdes.low_pass(
           1, 1e6, 10000, 2000, window.WIN_HAMMING, 6.76))
        self.dc_blocker_xx_0 = filter.dc_blocker_ff(32, True)
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.analog_sig_source_x_0 = analog.sig_source_c(2e6, analog.GR_COS_WAVE, self.frequency, 1, 0, 0)
#----------------------------------------------------------------------------
        ...
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.analog_sig_source_x_0 = analog.sig_source_c(2e6, analog.GR_COS_WAVE, self.frequency, 1, 0)
        ### end receiver blocks ###
