...
class RadioFlowGraph(gr.top_block):
    def __init__(self, radio_id, frequency, 
        tx_rf_gain=14, tx_if_gain=3, freq_offset=0, 
        ...
        self.analog_sig_source_x_2 = analog.sig_source_c(2e6, analog.GR_COS_WAVE, self.frequency, 1, 0)
        self.analog_sig_source_x_1 = analog.sig_source_c(2e6, analog.GR_COS_WAVE, 10000, 1, 0)
